...
public class MainActivity extends AppCompatActivity
    ...
    String alerta = "É necessario preencher o formulário";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        fab.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Snackbar.make(view, "http://portalsaude.saude.gov.br", Snackbar.LENGTH_LONG)
    ...
    public boolean validaFormulario(EditText alt, EditText peso, int sexo){
        ...
        if ( TextUtils.isEmpty(alt.getText().toString()) ){
            ...
            validado = false;
            peso.setError("preencher peso");
        }
        else if ( sexo < 0 ){
            validado = false;
            alerta = "selecionar o sexo";
        }
